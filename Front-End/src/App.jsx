...
function App() {
  ...
  clientId="TitYpIgfftCkWsvQqeubpvlN422hnevg"
  authorizationParams={{
    redirect_uri: window.location.origin,
    audience: "https://dev-o87gtr0hl6pu381w.us.auth0.com/api/v2/", // MUST match backend audience
    scope: "openid profile email write:workouts" // Added required scopes
  }}
